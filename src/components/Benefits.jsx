  ...
  return (
    <Section id="features">
      <div className="container relative z-2">
        <Heading className="md:max-w-md lg:max-w-2xl" title="Chat Smarter, Not Harder with Cognizance" />

        <div className="flex flex-wrap gap-10 mb-10 items-center justify-center">
          {benefits.map((item) => (
            <div
              className="block relative p-0.5 bg-no-repeat bg-cover bg-center md:max-w-[24rem]"
              style={{ backgroundImage: `url(${item.backgroundUrl})`, backgroundSize: "100% 100%", clipPath: "url(#benefits)" }}
              key={item.id}
            >
